...
c = Life.new(title: "Le Wagon Teacher", description: "Give remaining time before demo, with a sadic smile!", price_cents: 11000, user: u, address: "5333, casgrain, qc")
...
d = Life.new(title: "Thanos", description: "What I'm About To Do To Your Stubborn, Annoying Little Planet, I'm Gonna Enjoy It, Very, Very Much.", price_cents: 15000, user: a, address: "2727 rue cuvillier, montreal, qc")
...
e = Life.new(title: "Naked photo shoot", description: "Live my life as naked model", price_cents: 152300, user: b, address: "451 rue lagarde, montreal, qc")
...
f = Life.new(title: "Superman", description: "Come from Krypton, live my superhero life!", price_cents: 999900, user: u, address: "laval, qc")
...
g = Life.new(title: "Neil Armstrong", description: "Be the first human walking on the moon.", price_cents: 1999900, user: u, address: "brossard, qc")
...
h = Life.new(title: "Homer Simpson", description: "Woo Hoo!!!", price_cents: 122200, user: u, address: "verdun, qc")
...
i = Life.new(title: "Morty Smith", description: "I'm a version of your brother you can trust when he says. Don't run. Nobody exists on purpose. Nobody belongs anywhere. Everybody's gonna die.", price_cents: 122200, user: a, address: "westmount, qc")
...
j = Life.new(title: "Gandhi", description: "Be the change that you wish to see in the world.", price_cents: 1300, user: a, address: "joliette, qc")
...
k = Life.new(title: "David Gilmour", description: "Live a life in the most famous band of the world.", price_cents: 145300, user: a, address: "montreal, qc")
...
l = Life.new(title: "Jon Snow", description: "Lose all your family, fall in love of your aunt, and still knowing nothing.", price_cents: 145300, user: a, address: "Mont Tremblant, qc")
...
m = Life.new(title: "Captain Marvel", description: "Live the life of the most powerfull Avenger.", price_cents: 245300, user: a, address: "2727 rue cuvillier, montreal, qc")
...
n = Life.new(title: "New-Zealand Trip", description: "Travel during 2 months all arount the New-Zealand. Discover Auckland, Wellington, Milford Sound, Hobbiton...", price_cents: 2300, user: u, address: "2727 rue cuvillier, montreal, qc")
